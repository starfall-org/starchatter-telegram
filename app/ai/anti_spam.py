...
async def detector(content: str):
    messages = [{
        'role': 'system', 'content': '''You are spam detection AI. Your task is to analyze messages and determine if they are spam or not.
...
7. Messages that contain offensive or inappropriate content.'''}, {
    ...
    if result:
        ...
        result_json = {"is_spam": False, "content": content,
